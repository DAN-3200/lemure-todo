...
export function NavBar() {
	...
	return (
		<div className='w-134 bg-white p-2 h-12 flex gap-1 rounded-lg text-sm flex-row '>
			<OptionsBar
				text='ToDos'
				value={'todos'}
			/>
			...
			/>
			<button
				className='rounded px-4 w-max bg-purple-600 text-white font-bold text-whit ml-auto cursor-pointer'
				onClick={() => createNote()}>
				Create Note
			</button>
		</div>
